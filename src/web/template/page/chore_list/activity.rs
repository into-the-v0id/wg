...
use crate::web::application::chore_activity::ChoreActivityDeletePath;
...
use crate::web::application::chore_activity::ChoreActivityRestorePath;
use crate::web::application::chore_activity::ChoreActivityUpdatePath;
