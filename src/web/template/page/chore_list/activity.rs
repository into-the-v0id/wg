...
use crate::web::handler::chore::ChoreDetailPath;
use crate::web::handler::chore_activity::ChoreActivityCreatePath;
use crate::web::handler::chore_activity::ChoreActivityDeletePath;
use crate::web::handler::chore_activity::ChoreActivityDetailPath;
use crate::web::handler::chore_activity::ChoreActivityIndexPath;
use crate::web::handler::chore_activity::ChoreActivityRestorePath;
use crate::web::handler::chore_activity::ChoreActivityUpdatePath;
use crate::web::handler::chore_list::ChoreListIndexPath;
use crate::web::handler::chore_list_user::ChoreListUserDetailPath;
