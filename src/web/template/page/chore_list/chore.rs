...
use crate::web::handler::chore::ChoreActivitiesPath;
use crate::web::handler::chore::ChoreCreatePath;
use crate::web::handler::chore::ChoreDeletePath;
use crate::web::handler::chore::ChoreDetailPath;
use crate::web::handler::chore::ChoreIndexPath;
use crate::web::handler::chore::ChoreRestorePath;
use crate::web::handler::chore::ChoreUpdatePath;
