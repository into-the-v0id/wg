...
use crate::web::application::chore::ChoreActivitiesPath;
use crate::web::application::chore::ChoreCreatePath;
use crate::web::application::chore::ChoreDeletePath;
use crate::web::application::chore::ChoreDetailPath;
use crate::web::application::chore::ChoreIndexPath;
use crate::web::application::chore::ChoreRestorePath;
use crate::web::application::chore::ChoreUpdatePath;
use crate::web::application::chore_activity::ChoreActivityCreatePath;
