...
use crate::web::application::chore_list::ChoreListCreatePath;
use crate::web::application::chore_list::ChoreListDeletePath;
use crate::web::application::chore_list::ChoreListIndexPath;
use crate::web::application::chore_list::ChoreListRestorePath;
use crate::web::application::chore_list::ChoreListSettingsPath;
use crate::web::application::chore_list::ChoreListUpdatePath;
