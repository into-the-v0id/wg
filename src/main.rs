...
async fn main() {
    ...
    let router = Router::new()
        ...
        .route("/chore-lists/{chore_list_id}/chores", get(application::chore_list::view_chore_list))
        .route("/chore-lists/{chore_list_id}/chores/create", get(application::chore_list::view_create_chore_form).post(application::chore_list::create_chore))
        ...
        .route("/chore-lists/{chore_list_id}/activities", get(application::chore_list::view_activity_list))
        .route("/chore-lists/{chore_list_id}/activities/create", get(application::chore_list::view_create_activity_form).post(application::chore_list::create_activity))
